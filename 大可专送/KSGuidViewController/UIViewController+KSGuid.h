...
#define ImageArray @[@"NewFeature1",@"NewFeature2"]//@"NewFeature1",@"NewFeature2",@"NewFeature3"

/** pageIndicatorTintColor*/
#define pageTintColor [[UIColor lightGrayColor] colorWithAlphaComponent:0.5];
/** currentPageIndicatorTintColor*/
#define currentTintColor [UIColor grayColor];
