...
@interface AdjustTextView ()<UITextViewDelegate>
...
-(void)textViewDidChange:(UITextView *)textView{
    ...
    if ([self.textDelegate respondsToSelector:@selector(AdjustTextViewDidChange:height:)]) {
        [self.textDelegate AdjustTextViewDidChange:self height:textView.frame.size.height];
    }
}
